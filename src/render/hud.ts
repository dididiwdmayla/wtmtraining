...
export interface Telemetria {
  atualizar(velocidadeMs: number, guinadaRelativaRad: number): void;
}
 ...
 * sozinho, sem a mira sair do lugar no mundo.
 */
